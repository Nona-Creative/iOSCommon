...
class ValidatingTextField: UITextField, UITextFieldDelegate, ValidatingTextFieldValidator {
    ...
    @IBInspectable var rightImageValid: UIImage? = nil {
        didSet {
            setupRightView()
        }
    }
    ...
    @IBInspectable var rightImageShowSecureText: UIImage? = nil {
        didSet {
    ...
    */
    func validateAutomaticEditingChanged(_ textField: UITextField) {
    ...
    Callback function for text field changes
    */
    func validateAutomaticEditingDidEnd(_ textField: UITextField) {
